...
function preload() {
    ...
    jeu.scene.load.tilemapTiledJSON("map","assets/json/JeuPlateforme.json");
    jeu.scene.load.atlas("player","assets/images/player.png","assets/json/playerAtlas.json");
    jeu.scene.load.atlas("zombie","assets/images/zombie.png","assets/json/zombieAtlas.json");
    jeu.scene.load.image("spark","assets/images/particle.png");
    jeu.scene.load.audio("gemmeSound","assets/sounds/gemmeSound.ogg");

    jeu.scene.load.image("validation","assets/images/yellow_boxCheckmark.png");
    jeu.scene.load.image("panel","assets/images/yellow_panel.png");
