...
function preload() {
  this.load.image("joueur","assets/player.png");
  this.load.image("joueur_cdp","assets/player_kick.png");
  this.load.image("joueur_walk1","assets/player_walk1.png");
  this.load.image("joueur_walk2","assets/player_walk2.png");
  ...
  this.load.spritesheet("zombieSPS","assets/ZombieSpriteSheet.png", {frameWidth : 80, frameHeight : 110});

  this.load.audio("kick","assets/sounds/kick.ogg");
